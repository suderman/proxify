...
module.exports = function(command) {
  ...
  var argv = require('yargs')(command)
      ...
      .alias('l', 'LOGIN').describe('l', 'name:password').default('l', process.env.LOGIN || `${process.env.USER}:${process.env.USER}`)
      ...
      .alias('p', 'pass').describe('p', 'Authenticate with HTTP password, create .htpasswd').boolean('p')
